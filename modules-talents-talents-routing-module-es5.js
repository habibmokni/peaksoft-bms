...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-talents-talents-routing-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcModulesTalentsContainersListListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcModulesTalentsContainersTalentsTalentsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<ps-layout-talents><router-outlet></router-outlet></ps-layout-talents>\n";
    /***/
  },
  ...
  /***/
  function srcModulesTalentsComponentsIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcModulesTalentsContainersIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _talents_talents_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./talents/talents.component */
    ...
    __webpack_require__.d(__webpack_exports__, "TalentsComponent", function () {
      return _talents_talents_component__WEBPACK_IMPORTED_MODULE_1__["TalentsComponent"];
    });
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "ListComponent", function () {
      return _list_list_component__WEBPACK_IMPORTED_MODULE_2__["ListComponent"];
    });

    var containers = [_talents_talents_component__WEBPACK_IMPORTED_MODULE_1__["TalentsComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_2__["ListComponent"]];
    /***/
  },
  ...
  /***/
  function srcModulesTalentsContainersListListComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcModulesTalentsContainersListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _modules_talents_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @modules/talents/services */
    ...
    /*#__PURE__*/
    function () {
      function ListComponent(modalService, talentsService, cd, authService) {
        ...
        this.jobs = [{
          ...
          display: 'Front End Senior'
        }, {
          value: 'Front End Junior',
          display: 'Front End Junior'
        }, {
          value: 'Back End Senior',
          display: 'Back End Senior'
        }, {
          value: 'Back End Junior',
          display: 'Back End Junior'
        }, {
          value: 'Senior Fullstack',
          display: 'Senior Fullstack'
        }, {
          value: 'Junior Fullstack',
          display: 'Junior Fullstack'
        }, {
          value: 'Testautomatisierer',
          display: 'Testautomatisierer'
        }, {
          value: 'Werkstudent',
          display: 'Werkstudent'
        }];
        this.status = 'Contacted'; // notes = 'this.selectedProfil.notes';
      ...
      _createClass(ListComponent, [{
        ...
        value: function onSubmit(form) {
          ...
          // Send Http request
          this.talentsService.createandStoreTalents(form).subscribe(function (talents) {
            // this.isFetching = false;
            // this.loadedProfiles = talents;
            // this.cd.detectChanges();
            _this3.onFetchTalents();
          }, function (error) {
            // this.isFetching = false;
        ...
        key: "onFetchTalents",
        value: function onFetchTalents() {
          var _this4 = this;

          this.isFetching = true;
          this.talentsService.fetchTalents().subscribe(function (talents) {
            _this4.isFetching = false;
            _this4.loadedProfiles = talents;
        ...
        key: "onDeleteTalents",
        value: function onDeleteTalents(id) {
          var _this5 = this;

          console.log(id);
          this.talentsService.deleteTalent(id).subscribe(function () {
            _this5.loadedProfiles = [];

            _this5.cd.detectChanges();

            _this5.onFetchTalents();
          });
        }
      }, {
        key: "onFetchTalentProfil",
        value: function onFetchTalentProfil(id) {
          var _this6 = this;

          this.saveSelectedProfilID(id);
          console.log(id);
          this.talentsService.showTalentProfil(id).subscribe(function (value) {
            console.log(value);
            return _this6.selectedProfil = value;
          });
        }
      }, {
        key: "onUpdateTalentProfil",
        value: function onUpdateTalentProfil(form, id) {
          var _this7 = this;

          console.log(form);
          this.talentsService.updateProfil(form, this.selectedProfileID).subscribe(function (responseData) {
            console.log(responseData);
            _this7.ProfilData = responseData;

            _this7.onFetchTalents();
          }); // this.cd.detectChanges();
          // this.onFetchTalents();
        }
      }, {
        key: "saveSelectedProfilID",
        value: function saveSelectedProfilID(value) {
    ...
    ListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/modules/talents/containers/list/list.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./list.component.scss */
      "./src/modules/talents/containers/list/list.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"], _modules_talents_services__WEBPACK_IMPORTED_MODULE_3__["TalentsService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _modules_auth_services__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])], ListComponent);
    /***/
  },
  ...
  /***/
  function srcModulesTalentsContainersTalentsTalentsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcModulesTalentsContainersTalentsTalentsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TalentsComponent =
    /*#__PURE__*/
    function () {
      function TalentsComponent() {
        _classCallCheck(this, TalentsComponent);
      }

      _createClass(TalentsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    TalentsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'ps-talents',
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./talents.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/modules/talents/containers/talents/talents.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./talents.component.scss */
      "./src/modules/talents/containers/talents/talents.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], TalentsComponent);
    /***/
  },
  ...
  /***/
  function srcModulesTalentsGuardsIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _talents_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./talents.guard */
    "./src/modules/talents/guards/talents.guard.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "TalentsGuard", function () {
      return _talents_guard__WEBPACK_IMPORTED_MODULE_1__["TalentsGuard"];
    });

    var guards = [_talents_guard__WEBPACK_IMPORTED_MODULE_1__["TalentsGuard"]];
    /***/
  },
  ...
  /***/
  function srcModulesTalentsGuardsTalentsGuardTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function TalentsGuard() {
        _classCallCheck(this, TalentsGuard);
      }

      _createClass(TalentsGuard, [{
        key: "canActivate",
    ...
    TalentsGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], TalentsGuard);
    /***/
  },
  ...
  /***/
  function srcModulesTalentsServicesIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _talents_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./talents.service */
    "./src/modules/talents/services/talents.service.ts");
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "TalentsService", function () {
      return _talents_service__WEBPACK_IMPORTED_MODULE_1__["TalentsService"];
    });

    var services = [_talents_service__WEBPACK_IMPORTED_MODULE_1__["TalentsService"]];
    /***/
  },
  ...
  /***/
  function srcModulesTalentsServicesTalentsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function TalentsService(http, userServ, authService) {
        _classCallCheck(this, TalentsService);
      ...
      _createClass(TalentsService, [{
        key: "createandStoreTalents",
        value: function createandStoreTalents(form) {
          return this.http.post('https://peaksoft-47458.firebaseio.com/talents.json', form);
        }
      }, {
        key: "fetchTalents",
        value: function fetchTalents() {
          var param = {
            auth: localStorage.getItem('access-token')
          };
          return this.http.get('https://peaksoft-47458.firebaseio.com/talents.json', {
            params: param
            ...
            for (var key in responseData) {
              if (responseData.hasOwnProperty(key)) {
                talentsArray.push(Object.assign(Object.assign({}, responseData[key]), {
                  id: key
        ...
        key: "deleteTalent",
        value: function deleteTalent(id) {
          var param = {
            auth: localStorage.getItem('access-token')
          };
          return this.http["delete"]("https://peaksoft-47458.firebaseio.com/talents/".concat(id, ".json"));
        }
      }, {
        key: "showTalentProfil",
        value: function showTalentProfil(id) {
          var _this8 = this;

          var param = {
            auth: localStorage.getItem('access-token')
          };
          return this.http.get("https://peaksoft-47458.firebaseio.com/talents/".concat(id, ".json")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (responseData) {
            // console.log(responseData);
            _this8.ProfilData = responseData;
            return responseData;
          }));
        }
      }, {
        key: "updateProfil",
        value: function updateProfil(form, id) {
          console.log(id);
          return this.http.put("https://peaksoft-47458.firebaseio.com/talents/".concat(id, ".json"), form);
        }
      }]);
    ...
    TalentsService.ctorParameters = function () {
      return [{
    ...
    TalentsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _modules_auth_services__WEBPACK_IMPORTED_MODULE_3__["UserService"], _modules_auth_services__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])], TalentsService);
    /***/
  },
  ...
  /***/
  function srcModulesTalentsTalentsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TalentsRoutingModule", function () {
      return TalentsRoutingModule;
    });
    /* harmony import */
    ...
    var _talents_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./talents.module */
    ...
    var TalentsRoutingModule = function TalentsRoutingModule() {
      _classCallCheck(this, TalentsRoutingModule);
    };

    TalentsRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcModulesTalentsTalentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TalentsModule", function () {
    ...
    var TalentsModule = function TalentsModule() {
      _classCallCheck(this, TalentsModule);
    };

    TalentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=modules-talents-talents-routing-module-es5.js.map